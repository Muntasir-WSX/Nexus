	...
	return (
		<AnimatePresence mode="wait">
			<motion.div
				...
				className="h-full min-w-0 px-4 pb-4"
			>
			<div className="grid gap-6 lg:grid-cols-[240px_minmax(0,1fr)]">
				...
				<div className="min-w-0 pt-3">
					<h2 className="text-[38px] font-light leading-none tracking-tight text-gray-800">{contact.name}</h2>
			...
			<div className="mt-6 rounded-3xl border border-white/70 bg-white/70 p-3 shadow-sm">
				...
				/>
				<p className="mt-3 text-[22px] font-light leading-tight text-gray-800">{propertyPreview?.address}</p>
			</div>
			</motion.div>
		</AnimatePresence>
	);
